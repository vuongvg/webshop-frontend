...
function BannerTimer({}) {
   const product = { slug: " Lorem ipsum dolor sit.", name: " Lorem ipsum dolor sit." };
   const dataTimer = {
      product_subtitle: " Lorem ipsum dolor sit.",
      subtitle: " Lorem ipsum dolor sit.",
      title: " Lorem ipsum dolor sit.",
      product_title: " Lorem ipsum dolor sit.",
      background:'https://www.hm.com/nt-north/uploads/2022/07/7406C-CPD-TOP-3x2-1-1920x1280.jpg'
   };
            ...
            <div className="row gy-3">
               <div className="col-lg-12">
                  <div className="discount-image-details discount-spacing">
                     <img src={dataTimer.background} className="bg-img  lazyload" alt={product.name} />
                     ...
                     <div className="discunt-details">
                        <div>
                              ...
                              <ul>
                                 <li>
                                    <div className="counter">
                                       <div>
                                          <h2 id="days1" className="theme-color"></h2>
                                          Days
                                       </div>
                                    </div>
                                 </li>
                                 <li>
                                    <div className="counter">
                                       <div>
                                          <h2 id="hours1" className="theme-color"></h2>
                                          Hour
                                       </div>
                                    </div>
                                 </li>
                                 <li>
                                    <div className="counter">
                                       <div>
                                          <h2 id="minutes1" className="theme-color"></h2>
                                          Min
                                       </div>
                                    </div>
                                 </li>
                                 <li>
                                    <div className="counter">
                                       <div>
                                          <h2 id="seconds1" className="theme-color"></h2>
                                          Sec
                                       </div>
                                    </div>
                                 </li>
                           ...
                           <div className="timer-bg timer-bg-center d-lg-block d-none">
                              <h3 className="mt-0">{dataTimer.product_title}</h3>
                              <span>{dataTimer.product_subtitle}</span>
                           </div>
                        </div>
                     </div>
                  </div>
