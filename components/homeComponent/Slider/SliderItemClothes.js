            ...
            <div className="home-wrap row m-0">
                     ...
                     <div>
                        ...
                        <div className="d-flex">
                           <ul className="rating p-0 me-2">
                              {new Array(5).fill(null).map((value, index) => (
                                 <li key={index}>
                                    <i className={`fas fa-star ${index + 1 <= Number(product.average_rating) ? "theme-color" : ""}`}></i>
                                 </li>
                              ))}
                           </ul>
                           <h6 className="text-light">({product.rating_count} Review )</h6>
                        </div>
                        ...
                        <div className="add-btn">
                           <Link href={"/product/" + product.slug}>
                              <a className="btn btn-white">View product</a>
                           </Link>
                        </div>
                           ...
                           <ul className="share-icons p-0">
                              <li>
                                 <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=#url">
                                    <img src="images/social-icon/4.png" className="img-fluid lazyload" alt="social icon" />
                                 </a>
                              </li>
                              <li>
                                 <a href="https://www.google.co.in/">
                                    <img src="images/social-icon/5.png" className="img-fluid lazyload" alt="social icon" />
                                 </a>
                              </li>
                              <li>
                                 <a href="http://www.twitter.com/share">
                                    <img src="images/social-icon/6.png" className="img-fluid lazyload" alt="social icon" />
                                 </a>
                              </li>
                           </ul>
                        </div>
               ...
               <div className="col-xxl-9 col-lg-8 p-0 left-content">
                  <img
                     ...
                     // src='https://themes.pixelstrap.com/voxo/front-end/assets/images/fashion/slider/1.jpg'
                     className="bg-img lazyload image-fit"
                     alt=""
                  />
