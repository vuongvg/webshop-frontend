...
function ClothReview({ description, average_rating, rating_count, id, question_and_answers, specifications, guide, review }) {
   return (
            ...
            <div className="col-12">
               <div className="cloth-review">
                  ...
                  <div className="tab-content" id="nav-tabContent">
                     ...
                     <ReviewsProduct id={id} average_rating={average_rating} rating_count={rating_count} review={review} />
                  </div>
               </div>
            </div>
         </div>
