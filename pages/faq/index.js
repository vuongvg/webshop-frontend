            ...
            <div className="container">
               <div className="row g-lg-5 g-4">
                  <div className="col-md-4 zi-1">
                     <div className="faq-contain">
                        <div className="faq-image">
                           <img src="/images/inner-page/faq/guides.png" className="img-fluid lazyload" alt="" />
                        </div>
                        <h2>Guides</h2>
                  ...
                  <div className="col-md-4 zi-1">
                     <div className="faq-contain">
                        <div className="faq-image">
                           <img src="/images/inner-page/faq/faq.png" className="img-fluid lazyload" alt="" />
                        </div>
                        <h2>FAQ</h2>
                  ...
                  <div className="col-md-4 zi-1">
                     <div className="faq-contain">
                        <div className="faq-image">
                           <img src="/images/inner-page/faq/community.png" className="img-fluid lazyload" alt="" />
                        </div>
                        <h2>Community</h2>
